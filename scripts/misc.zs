...
recipes.addShaped(<buildcraftfactory:pump>, [[<openblocks:tank>, <buildcraftsilicon:redstone_chipset:1>, <openblocks:tank>],[<thermalfoundation:material:290>, <buildcraftfactory:mining_well>, <thermalfoundation:material:290>], [null, <buildcrafttransport:pipe_quartz_fluid>, null]]);mods.buildcraft.AssemblyTable.addRecipe(<thermalexpansion:frame>, 40000, [<ic2:plate:16>, <railcraft:generic:7> * 2, <forestry:chipsets>.withTag({T: 0 as short}), <thermalfoundation:material:257>, <buildcraftsilicon:redstone_chipset:1>]);
